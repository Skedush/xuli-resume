              ...
              <div className="mt-6 pt-6 border-t border-white/5">
                ...
                <div className="flex flex-wrap gap-2">
                  {['数据结构', '算法设计', '操作系统', '计算机网络', '数据库原理', '软件工程', '面向对象编程'].map((course) => (
                    <span key={course} className="px-3 py-1 bg-[var(--xuli-bg-secondary)] text-[var(--xuli-text-tertiary)] text-sm rounded">
                      {course}
                    </span>
                  ))}
                </div>
            ...
            <div className="bg-[var(--xuli-bg-tertiary)] rounded-lg p-6 border border-white/5">
              ...
              <div className="space-y-3">
                {certificates.map((cert, i) => (
                  <div key={i} className="bg-[var(--xuli-bg-secondary)] rounded-lg p-3">
              ...
              <div className="space-y-3">
                {openSourceContributions.map((item, i) => (
                  <a
                    ...
                    className="block bg-[var(--xuli-bg-secondary)] rounded-lg p-3 hover:bg-[var(--xuli-bg-tertiary)] transition-colors"
                  >
                    <div className="flex items-center justify-between mb-1">
