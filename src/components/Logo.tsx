  ...
  return (
    <div className="logo-sketch w-10 h-10 bg-[var(--xuli-bg-tertiary)] border-2 border-border flex items-center justify-center">
      <svg className="w-5 h-5" viewBox="0 0 100 100">
        <defs>
          <filter id="roughen"><feTurbulence baseFrequency="0.035" numOctaves="2" seed="3" result="noise" /><feDisplacementMap in="SourceGraphic" in2="noise" scale="1.2" /></filter>
        </defs>
        <g filter="url(#roughen)" fill="none" stroke="var(--xuli-accent)" strokeLinecap="round" strokeLinejoin="round">
